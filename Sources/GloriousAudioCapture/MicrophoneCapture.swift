...
public protocol AudioSourceCapturing: AnyObject {
...
public final class AudioCapture: AudioSourceCapturing {
    ...
    public static func requestAuthorization(_ completion: @escaping (AudioSourceAuthorization) -> Void) {
